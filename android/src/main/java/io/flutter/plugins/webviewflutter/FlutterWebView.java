...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  protected static final String LOG_TAG = "FlutterWebView";
  private static final String JS_CHANNEL_NAMES_FIELD = "javascriptChannelNames";
  private final WebView webView;
  private final MethodChannel methodChannel;
  private final FlutterWebViewClient flutterWebViewClient;
  private final Handler platformThreadHandler;
  private boolean useDefaultShowFileChooser = true;
...
//        filePathCallback = null;
  ...
  FlutterWebView(
    ...
    if (params.containsKey("useDefaultShowFileChooser")) {
      this.useDefaultShowFileChooser = (boolean) params.get("useDefaultShowFileChooser");
    }
  }
